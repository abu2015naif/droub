...
export const GLOBAL_SEO_KEYWORDS = [
  "دروب السلامة", "Droub Al Salamah", "معدات السلامة بالسعودية", "أدوات السلامة المهنية", 
  "السلامة المرورية", "معدات الوقاية الشخصية", "PPE", "أدوات الإطفاء", "أنظمة الحريق",
  "طفايات حريق", "طفاية حريق بودرة", "طفاية حريق ثاني أكسيد الكربون", "طفاية حريق CO2", 
  "تركيب أنظمة حريق", "كواشف دخان", "كواشف حرارة", "جرس إنذار حريق", "لوحة إنذار حريق", 
  "صناديق حريق", "خراطيم حريق", "مضخات حريق UL FM", "صيانة أدوات السلامة", "تعبئة طفايات",
  "خوذة سلامة", "أحذية سلامة سفتي", "سترة عاكسة", "قفازات عمل", "كمامات حماية", "سدادات أذن",
  "نظارات حماية", "حزام أمان للعمل", "أدوات هبوط وصعود", "إسعافات أولية", "نشرة طبية",
  "مخاريط مرورية", "لوحات إرشادية", "مرايا مقعرة", "مصدات مواقف", "أعمدة مرنة", "عيون قطط",
  "معدات الدفاع المدني", "ترخيص الدفاع المدني", "شهادة إنجاز سلامة", "مكتب استشارات سلامة",
  "الرياض", "جدة", "الدمام", "مكة", "المدينة", "القصيم", "تبوك", "حائل", "جيزان", "نجران",
  "أسعار أدوات السلامة", "توصيل سريع معدات حريق", "متجر سلامة معتمد", "قطع غيار أنظمة حريق"
].join(", ");
