...
export const GLOBAL_SEO_KEYWORDS = [
  ...
  "أدوات السلامة بجدة", "أدوات السلامة بالرياض", "شركة إطفاء حريق", "أجهزة إنذار حريق",
  "معدات حماية شخصية", "ملابس سلامة", "أحذية حماية", "نظارات سلامة", "خوذة حماية",
  "كمامات تنفس", "أجهزة كشف الغاز", "شبكات حريق", "رشاشات حريق", "أبواب حريق",
  "معدات إنقاذ", "أدوات طوارئ", "لوحات تحذيرية", "أشرطة تحذيرية", "مطب صناعي",
  "شركة توريد معدات سلامة", "مورد طفايات حريق", "عقود صيانة سلامة", "كاشف دخان لاسلكي",
  "بخاخ حريق", "بطانية حريق", "أقنعة غاز", "فلف حريق", "كابينة حريق", "محبس حريق"
].join(", ");
